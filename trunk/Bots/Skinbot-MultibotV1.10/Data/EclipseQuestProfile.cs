            ...
            foreach (var q in QuestOrders){
                ...
                if (result != null) 
                {
                    if (result.Rows.Count > 0) //This one already exists.
                    {
                        ...
                        if (qo.KillCount != null && qo.KillCount != string.Empty) q.KillCount = qo.KillCount;
                        if (qo.MobId != null && qo.MobId != string.Empty) q.MobId = qo.MobId;
                        if (qo.CollectCount != null && qo.CollectCount != string.Empty) q.CollectCount = qo.CollectCount;
