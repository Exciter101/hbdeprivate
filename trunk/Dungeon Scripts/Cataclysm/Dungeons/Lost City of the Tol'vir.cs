	...
	public class LostCityOfTheTolvir : Dungeon
	{
		...
		public override void RemoveTargetsFilter(List<WoWObject> units)
		{
			units.RemoveAll(
				...
				{
					var unit = ret.ToUnit();
                    // these guys are fighting each other indefinitely and they can be ignored since they're off the path
                    // unless bot gets in combat with one of them.
					if (_enslavedBanditIds.Contains(ret.Entry) && !unit.IsTargetingMyPartyMember 
