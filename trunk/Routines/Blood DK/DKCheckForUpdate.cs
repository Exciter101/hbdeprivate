    ...
    class svnUpdates
    {
        ...
        public static void CheckForUpdate()
        {
            try
            {
                ...
                {
                    string newRevison = "New SVN update available, you are on Revision: " + revision + " latest is: " + onlineRevision;
                    Lua.DoString("RaidNotice_AddMessage(RaidWarningFrame, \"" + newRevison + "\", ChatTypeInfo[\"RAID_WARNING\"]);");
