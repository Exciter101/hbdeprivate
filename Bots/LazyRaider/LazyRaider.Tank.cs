...
namespace Styx.Bot.CustomBots
{
    public class Tank
    {
        public static WoWGuid _tankGuid;
        static ObjectInvalidateDelegate invalidDelegate;

        public static WoWGuid Guid
        {
        ...
        public static WoWPartyMember Current
        {
            ...
            set
            {
                Tank.Guid = value == null ? WoWGuid.Empty : value.Guid;
            }
        }
        ...
        public static void SetAsLeader(WoWGuid guidNew)
        {
            WoWPlayer p = null;
            Tank.Guid = guidNew;

            if (Tank.Guid.IsValid )
