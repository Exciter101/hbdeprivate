...
namespace Bots.DungeonBuddy.Dungeon_Scripts.Mists_of_Pandaria
{
	public class TerraceOfEndlessSpring : Dungeon
	{
		...
		public Func<WoWUnit, Task<bool>> LeiShiEncounter()
		{
			...
			AddAvoidObject(ctx => true, 3, o => o.Entry == LeiShiId && o.ToUnit().CurrentTargetGuid.IsValid && o.ToUnit().CurrentTargetGuid != Me.Guid, o => o.ToUnit().CurrentTarget.Location);
			...
			return async boss =>
			{
				...
				else if (Me.IsRange() && Me.Location.DistanceSqr(safeZoneLoc) < 60*60)
				{
					if (randomSpotAtSafeLoc == WoWPoint.Zero)
						randomSpotAtSafeLoc = WoWMathHelper.GetRandomPointInCircle(safeZoneLoc, 7);
