	...
	public class TheUnderhold : Dungeon
	{
        ...
        public override void IncludeLootTargetsFilter(List<WoWObject> incomingObjects, HashSet<WoWObject> outgoingunits)
        {
            foreach (var obj in incomingObjects)
            {
                ...
                if (gObj != null && gObj.Entry == GameObjectId_UnlockedStockpileofPandarenSpoils && gObj.CanUse() 
        ...
        const uint GameObjectId_UnlockedStockpileofPandarenSpoils = 232166;
											...
											new Decorator(ctx => sopUpdateWaitPoint.IsFinished,
												new Action(
													ctx =>
													{
														...
														mySopWaitPoint = WoWMathHelper.GetRandomPointInCircle(centerMovePoint, 5);
